...
> 打开编辑窗口Modal的时候会出现短暂的卡顿，并且在点击Cancel关闭后也并不是立即响应而是稍作迟疑之后才关闭的

#### 改造后：

> 改造完成后整个Modal的打开比之前变得流畅了不少，可以做到立即响应用户的点击事件唤起/关闭Modal
...
![图 1](https://wongabner.coding.net/p/picgo/d/mdimg/git/raw/master/2022-01-17-15-33-51.png)  
