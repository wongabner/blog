...
举个例子，我们在开发一个博客系统，当我们要创建一篇文章的时候往往用 POST https://www.xxx.com/articles ，这个请求的语义是，在articles的资源集合下创建一篇新的文章，如果我们多次提交这个请求会创建多个文章，这是非幂等的。

而 PUT https://www.xxx.com/articles/820357430 的语义是更新对应文章下的资源(比如修改作者名称等)，这个URI指向的就是单一资源，而且是幂等的，比如你把『刘德华』修改成『蔡徐坤』，提交多少次都是修改成『蔡徐坤』
...
比如我们有一篇文章的地址 https://www.xxx.com/articles/820357430 ,这篇文章的可以表示为:
...
当我们要修改文章的作者时，我们可以直接发送 PUT https://www.xxx.com/articles/820357430 ，这个时候的数据应 该是:
...
这种直接覆盖资源的修改方式应该用put，但是你觉得每次都带有这么多无用的信息，那么可以发送 PATCH https://www.xxx.com/articles/820357430 ，这个时候只需要:
...
![图 8](https://wonganber-picgo.oss-cn-hangzhou.aliyuncs.com/picgo/2021-03-25-06-04-25.png)  
...
![图 9](https://wonganber-picgo.oss-cn-hangzhou.aliyuncs.com/picgo/2021-03-25-06-05-27.png)
...
![图 10](https://wonganber-picgo.oss-cn-hangzhou.aliyuncs.com/picgo/2021-03-25-06-06-25.png)  
